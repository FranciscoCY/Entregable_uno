...
public class TypeAccountController {
    ...
    public Mono<ResponseEntity<Mono<TypeModel>>> createType(@RequestBody final TypeModel typeModel) {
        ...
        return Mono.just(new ResponseEntity<>(typeMono, typeMono != null ? HttpStatus.CREATED : HttpStatus.BAD_REQUEST));
    }
    ...
    @PutMapping("/{id}")
    public Mono<ResponseEntity<TypeModel>> update(@RequestBody final TypeModel typeModel, @PathVariable final String id) {
